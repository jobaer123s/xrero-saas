...
BACKUP_SCRIPT_PATH = "/opt/odoo17/SAAS/SAAS-addons/wk_backup_restore/models/lib/saas_client_backup.py"
...
if __name__ == '__main__':
    ...
    module_path = '/opt/odoo17/SAAS/SAAS-addons/wk_backup_restore/models/lib/saas_client_backup.py'
